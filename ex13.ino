...
char ss[3]; //土壤濕度文字格式
char _lwifi_ssid[] = "Andy's HTC";
char _lwifi_pass[] = "anDy(861003)";

MCSDevice mcs("D6VklWGJ", "APyypvPAJguFNQ1c");
MCSDisplayInteger temp("temp"); //溫度
MCSDisplayInteger humid("humid"); //濕度
MCSDisplayInteger soil("soil"); //土壤濕度
MCSControllerOnOff MySwitch("Switch"); //風扇手動開關
MCSControllerOnOff MySwitch1("MySwitch"); //噴水手動開關
